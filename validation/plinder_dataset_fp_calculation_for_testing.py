    ...
    [
        {
            ...
            "CSK": {"SMILES": "C[Se]SC[C@@H](C(=O))N"},
            "CRO": {
                "SMILES": r"C[C@H]([C@@H](C1=N/C(=C\\c2ccc(cc2)O)/C(=O)N1CC(=O))N)O"
            },
            "CSX": {"SMILES": "	C([C@@H](C(=O))N)[S@H]=O"},
            "CZZ": {"SMILES": "C([C@@H](C(=O))N)S[As]O"},
            "CSD": {"SMILES": "C([C@@H](C(=O))N)[S@@](=O)O"},
            # "HYP": {"SMILES": "C1[C@H](CN[C@@H]1C(=O)O)O"}, # need to check
            # "GMA": {"SMILES": "C(CC(=O)O)[C@@H](C(=O)N)N"}, # need to check
            "TPQ": {"SMILES": "C1=C(C(=O)C=C(C1=O)O)C[C@@H](C(=O))N"},
            "CSS": {"SMILES": "C([C@@H](C(=O))N)SS"},
            "MYK": {"SMILES": "CCCCCCCCCCCCCC(=O)NCCCC[C@@H](C(=O))N"},
            "PTR": {"SMILES": "c1cc(ccc1C[C@@H](C(=O))N)OP(=O)(O)O"},
            "MLY": {"SMILES": "CN(C)CCCC[C@@H](C(=O))N"},
            "PFF": {"SMILES": "c1cc(ccc1C[C@@H](C(=O))N)F"},
            "CAS": {"SMILES": "C[As](C)SC[C@@H](C(=O))N"},
            "K5L": {"SMILES": "C([C@H](C(=O))N)OC(=O)CC(=O)O"},
            "CME": {"SMILES": "C(CSSC[C@@H](C(=O))N)O"},
            "3ZL": {"SMILES": r"C=C(C(=O)/C=C\\NCCCC[C@@H](C(=O))N)N"},
            "L5P": {
                "SMILES": "C(CCNCC(=O)[C@@H]([C@@H](COP(=O)(O)O)O)O)C[C@@H](C(=O))N"
            },
        }
    ]
)
...
for idx in tqdm(df_index.index):
    ...
    if (
        pathlib.Path(f"./test/explicit/fp_{idx}.pkl").exists()
        and pathlib.Path(f"./test/implicit/fp_{idx}.pkl").exists()
    ):
        continue
