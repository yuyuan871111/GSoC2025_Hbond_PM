...
if "MSMS_BIN" in config["ThirdParty"]:
    ...
    set_trace()
    print("ERROR: MSMS_BIN not set. Variable should point to MSMS program.")  # noqa: T201
    sys.exit(1)
...
if "REDUCE_BIN" in config["ThirdParty"]:
    ...
    print("ERROR: REDUCE_BIN not set. Variable should point to REDUCE program.")  # noqa: T201
    sys.exit(1)
...
if "PDB2PQR_BIN" in config["ThirdParty"]:
    ...
    print("ERROR: PDB2PQR_BIN not set. Variable should point to PDB2PQR_BIN program.")  # noqa: T201
    sys.exit(1)
...
if "APBS_BIN" in config["ThirdParty"]:
    ...
    print("ERROR: APBS_BIN not set. Variable should point to APBS program.")  # noqa: T201
    sys.exit(1)
...
if "MULTIVALUE_BIN" in config["ThirdParty"]:
    ...
    print("ERROR: MULTIVALUE_BIN not set. Variable should point to MULTIVALUE program.")  # noqa: T201
    sys.exit(1)
